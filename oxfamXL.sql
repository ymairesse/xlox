...
--
-- Hôte : localhost:3306
-- Généré le : mar. 01 août 2023 à 20:11
...
CREATE TABLE `ox_bonsAccessoires` (
  `numeroBon` tinyint(4) NOT NULL COMMENT 'Numéro du bon de réparation',
  `idAccessoire` tinyint(4) NOT NULL COMMENT 'Identifiant de l''accessoire'
...
INSERT INTO `ox_bonsReparation` (`numeroBon`, `idUser`, `typeMateriel`, `marque`, `modele`, `dateEntree`, `dateSortie`, `benevole`, `probleme`, `etat`, `devis`, `remarque`, `apayer`, `termine`) VALUES
(1, 1, 1, 'Dell', 'Probook', '2023-07-25', '2023-07-27', 'Thomas', 'Très lent', 'Capot griffé.', 'Ajout de 4GB RAM -> 25€\r\nChangement du disque dur -> SSD 256GB -> 50€', 'Nettoyage interne pour éliminer la poussière nécessaire.', NULL, 0),
(2, 1, 1, 'HP', 'Probook', '2023-07-25', '2023-07-27', 'Yves', 'Ne boote plus', '', 'Ce sera pas cher', '', NULL, 0);
...
(1, 'F', 'tests', 'Bidule', '0474754696', '', 'toto@hotmail.com', '', '1050', 'Ixelles', 'client', '2023-07-31 12:03:03'),
(2, 'M', 'Mairesse', 'Yves', '026737220', '0474754696', 'ymairesse@sio2.be', 'Av. Daniel Boon, 59', '1160', 'Bruxelles', 'root', '2023-07-31 12:00:47'),
(4, 'M', 'testicule', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'client', '2023-07-31 13:46:04'),
(5, 'F', 'testich', '', '0474754696', '', '', '', '1160', '', 'client', '2023-07-31 14:07:03'),
(6, 'M', 'Bidule', 'Machin', '026737220', '0474754696', 'yves@sio2.be', 'ici', '1160', 'tout là bas', 'client', '2023-07-31 14:08:35'),
(7, NULL, 'test', '', '0474754696', '', '', '', '1160', '', 'client', '2023-07-31 14:10:27'),
(8, NULL, 'test', '', '0474754696', '', '', '', '1160', '', 'client', '2023-07-31 14:10:47'),
(9, NULL, 'tests', '', '0474754696', '', '', '', '1160', '', 'client', '2023-07-31 14:11:20'),
(10, NULL, 'tests', '', '0474754696', '', '', '', '1160', '', 'client', '2023-07-31 14:11:23');
...
--
ALTER TABLE `ox_bonsReparation`
  MODIFY `numeroBon` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Numéro du bon de réparation', AUTO_INCREMENT=3;
...
--
ALTER TABLE `ox_users`
  MODIFY `idUser` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Identifiant unique', AUTO_INCREMENT=11;
...
--
ALTER TABLE `ox_bonsAccessoires`
  ADD CONSTRAINT `ox_bonsAccessoires_ibfk_1` FOREIGN KEY (`idAccessoire`) REFERENCES `ox_accessoires` (`idAccessoire`) ON DELETE CASCADE;

--
-- Contraintes pour la table `ox_bonsReparation`
--
ALTER TABLE `ox_bonsReparation`
  ADD CONSTRAINT `ox_bonsReparation_ibfk_1` FOREIGN KEY (`typeMateriel`) REFERENCES `ox_typeMateriel` (`idTypeMateriel`) ON DELETE CASCADE;
COMMIT;
