      ...
      <div class="modal-header">
        <h5 class="modal-title w-100" id="modalEditClientLabel">
          ...
          <button 
            type="button" 
            id="btnChangeType" 
            class="btn btn-primary btn-sm float-end me-4 btn-typeClient btn4entreprise"
      ...
      <div class="modal-body">
        ...
        <form autocomplete="off" id="modalFormClient">
          ...
          <div class="pb-3 col-2">
            ...
            <!-- informations provenant éventuellement d'une fiche client "entreprise"-->
            <input type="hidden" name="tva" value="{$dataClient.tva|default:''}">
