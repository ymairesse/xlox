    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h1 class="modal-title fs-5 w-100" id="modalEditClientLabel">
          Fiche Client {if $typeClient == 'prive'}Privé{else}Entreprise{/if}

          <div class="btn-group float-end pe-3">
            <select name="lang" id="lang"
            data-bs-toggle="tooltip"
            data-bs-title="Language">
            ...
            <button
              class="btn btn-warning btn-sm visuChamps"
            ...
            <button
              class="btn btn-success btn-sm visuChamps"
              data-type="devis"
              data-bs-toggle="tooltip"
            ...
            <button
              class="btn btn-danger btn-sm visuChamps"
              data-type="facture"
              data-bs-toggle="tooltip"
      ...
      <div class="modal-body">
        <form autocomplete="false" id="modalFormClient">
          ...
          />
          <input type="hidden" name="typeClient" id="typeClient" value="{$typeClient}">
          ...
          <div class="row">
            ...
            <div class="form-group pb-3 {if $typeClient == 'entreprise'}col-12{else}col-5{/if}">
              <label for="nom">
                <span data-lang="fr">Nom{if $typeClient == 'entreprise'} de l'entreprise{/if}</span>
              ...
              <input
                ...
                placeholder="Nom{if $typeClient == 'entreprise'} de l'entreprise{/if}"
                required
              />
            </div>
            {if $typeClient == 'prive'}
            ...
            <div
              ...
              data-bs-toggle="tooltip"
              data-bs-title="Au moins l'un des champs (GSM ou téléphone)"
            >
              <label for="gsm"
            ...
            >
              ...
              <input
                type="mail"
                class="form-control facture reparation"
                name="mail"
                id="mail"
                value="{$dataClient.mail|default:''}"
                placeholder="Adresse mail"
                {if $typeClient == 'entreprise'}required{/if}
              />
            </div>
  ...
  $(document).ready(function () {
    ...
    $("#modalFormClient").validate({
      ...
      rules: {
        ...
        mail: {
          required: function(){
            return ($('#typeClient').val() == 'entreprise');  
          },
          email: true,
        },
        tva: {
