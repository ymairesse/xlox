          ...
          <div class="row">
            ...
            <div class="col-12 form-group pb-3">
              <label for="accessoires" class="w-100">Accessoires déposés
                <div class="btn-group float-end">
                  <button type="button" id="btn-editAccessoires" 
                    class="btn btn-sm btn-warning py-0"
                    data-numerobon="{$dataBon.numeroBon}">
                    <i class="fa fa-edit"></i>
                  </button>
                  <button type="button" id="btn-newAccessoire" 
                    class="btn btn-sm btn-info py-0" 
                    data-numerobon="{$dataBon.numeroBon}">
                    <i class="fa fa-plus"></i>
                  </button>
...
{$dataBon.remarque|default:''}</textarea
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6 pb-3">
              <label for="enCours">En cours / Terminé</label>
              <div
                class="btn-group w-100"
                role="group"
                aria-label="Terminé ou en cours"
              >
            ...
            <div class="col-md-3 col-sm-6 form-group pb-3">
