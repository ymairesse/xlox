<page backimg="../../css/oxfambg.jpg" backtop="35mm" backbottom="30mm" backleft="10mm" backright="10mm">
    ...
    <table style="width: 100%">
      <tr>
        <td style="width: 50%; padding: 0 20px">
          ...
          <h3 class="texteGras" style="text-align: center">DEVIS informatique</h3>

        </td>
        <td style="width: 50%; padding: 0 20px">
          <p class="inverse texteGras" style="margin: 0">Données du client</p>
          <p>
            Devis n°: <strong>{$dataDevis.ref}</strong> du
  ...
  <p style="margin: 10; font-size: 9pt;">L'offre suivante est valable <strong>trois mois</strong> à partir de la date du 
    <strong>{$dataDevis.date|date_format:"%d/%m/%Y"}</strong>.<br>
    Si un ou plusieurs articles mentionnés devenaient momentanément ou définitivement indisponibles, nous nous engageons à proposer
    un matériel équivalent pour le prix indiqué.
  </p>
