<div class="btn-group w-100">
  <a href="#" class="btn btn-danger btn-delGarantie"
    ...
    ><i class="fa fa-times"></i> Supprimer la garantie #{$ticketCaisse}</a
  >
  ...
  >
    <i class="fa fa-edit"></i> Modifier la garantie #{$ticketCaisse}
  </a>
  ...
  >
    <i class="fa fa-print"> </i> Imprimer la garantie #{$ticketCaisse}
  </a>
</div>
